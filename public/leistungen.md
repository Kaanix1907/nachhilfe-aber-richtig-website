...
### Einzelunterricht
- Gruppengröße: eine Schülerin oder ein Schüler
- Ort: Friedrich-Alfred-Straße 14, 47226 Duisburg
- Geeignet für: größere Lücken, anstehende Prüfungen, Kinder die in der Gruppe
  untergehen

### Onlineunterricht
- Ort: online
- Lehrkräfte und Konzept: dieselben wie vor Ort
- Geeignet für: weitere Anfahrt, eng getakteten Nachmittag, Krankheit

### Probestunde
- Umfang: die erste Stunde
- Kosten: keine
- Verpflichtung: keine

## Fächer

| Fach | Klassenstufen | Prüfungsfach ZP10 |
|---|---|---|
| Mathematik | 1 bis Abitur | ja |
| Deutsch | 1 bis Abitur | ja |
| Englisch | 1 bis Abitur | ja |
| Physik | Mittelstufe bis Abitur | nein |
| Chemie | Mittelstufe bis Abitur | nein |
| Biologie | Mittelstufe bis Abitur | nein |

## Schulformen

Grundschule, Realschule, Gesamtschule, Gymnasium, Berufskolleg.
...
- Anspruchsberechtigt: Familien mit Bürgergeld, Sozialhilfe nach SGB XII,
  Wohngeld, Kinderzuschlag oder Leistungen nach dem Asylbewerberleistungsgesetz
- Kosten für die Familie: keine
- Abrechnung: direkt mit dem Jobcenter Duisburg beziehungsweise der Stadt Duisburg
- Voraussetzung: die Schule bestätigt den Förderbedarf
- Unterstützung beim Antrag: ja, einschließlich der Formulare, die der Anbieter
  ausfüllen muss
- Ausführlich: https://nachhilfe-aber-richtig.de/bildung-und-teilhabe

## Zentrale Prüfungen Klasse 10 (ZP10, in NRW auch ZAP)
...
Geprüfte Lehramtsstudierende und Lehrkräfte, alle mit erweitertem
Führungszeugnis, eingesetzt nur in Fächern, die sie sicher beherrschen.
